      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            <div className="w-full p-2 sm:p-4 border rounded-lg font-mono text-xs sm:text-sm bg-gray-50">
            ...
            <div className="mt-4 flex gap-2 sm:gap-4">
              <button
                ...
                className="flex items-center gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
              >
              ...
              <button
                onClick={resetDemo}
                className="flex items-center gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700"
              >
          ...
          {analysis && (
            <div className="mb-4 sm:mb-6">
              ...
              <div className="bg-gray-50 rounded-lg p-2 sm:p-4">
                <h3 className="text-lg font-bold mb-2 sm:mb-3 flex items-center gap-2">
          ...
          {showExecution && (
            <>
              ...
              <div className="mb-4 sm:mb-6 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {/* Execution Steps */}
                <div>
                  ...
                  <div className="bg-gray-900 text-green-400 p-2 sm:p-4 rounded-lg font-mono text-xs sm:text-sm h-40 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                {/* Static Memory */}
                <div className="border-2 border-blue-200 rounded-lg p-2 sm:p-4">
                  <div className="flex items-center gap-2 font-bold mb-2 sm:mb-4">
                ...
                {/* Stack Memory */}
                <div className="border-2 border-yellow-200 rounded-lg p-2 sm:p-4">
                  <div className="flex items-center gap-2 font-bold mb-2 sm:mb-4">
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          {frame.variables.map((variable, j) => (
                            <div 
                              key={j} 
                              className="text-xs sm:text-sm text-yellow-700 font-mono pl-4"
                            >
                              {variable}
                            </div>
                          ))}
                ...
                {/* Heap Memory */}
                <div className="border-2 border-green-200 rounded-lg p-2 sm:p-4">
                  <div className="flex items-center gap-2 font-bold mb-2 sm:mb-4">
              ...
              <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
                <div className="flex justify-between items-center mb-2 sm:mb-4">
                  ...
                  <button
                    ...
                    className="px-2 sm:px-4 py-1 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400"
                  >
                    Next Step
                  </button>
                </div>
